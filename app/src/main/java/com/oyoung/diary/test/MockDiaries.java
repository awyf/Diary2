...
public class MockDiaries {
    private static final String DESCRIPTION = "今天,天气晴朗,在信雅达大厦里,我成功解决了Vi218-A-SU806的需求";
    ...
    public static Map<String, Diary> mock(Map<String, Diary> data) {
        ...
        Diary test2 = getDiary("2018-11-02  艺术节");
        data.put(test2.getId(), test2);
        Diary test3 = getDiary("2018-11-02  艺术节");
        data.put(test3.getId(), test3);
        Diary test4 = getDiary("2018-11-02  艺术节");
        data.put(test4.getId(), test4);
        Diary test5 = getDiary("2018-11-02  艺术节");
        data.put(test5.getId(), test5);
        Diary test6 = getDiary("2018-11-02  艺术节");
        data.put(test6.getId(), test6);
        Diary test7 = getDiary("2018-11-02  艺术节");
        data.put(test7.getId(), test7);
        Diary test8 = getDiary("2018-11-02  艺术节");
        data.put(test8.getId(), test8);
        Diary test9 = getDiary("2018-11-02  艺术节");
